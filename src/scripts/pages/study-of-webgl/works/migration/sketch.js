...
import {GPUComputationRenderer} from '../../modules/GPUComputationRenderer';
...
export class Sketch {
  ...
  setupCamera() {
    ...
    this.cameraP = new THREE.Vector3(this.dist * 0.01, 0, this.dist * 0);
...
class Shape {
  ...
  setPositions(texture) {
    ...
    for (let i = 0; i < arr.length; i += 4) {
      ...
      arr[i + 2] = Math.random() * this.sketch.dist - this.sketch.dist / 2;
      arr[i + 3] = 0;
    }
  }
