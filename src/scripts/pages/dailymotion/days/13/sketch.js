...
export class Sketch {
  ...
  initialize() {
    ...
    this.ease2 = Ease.returnEaseFunc('easeInOutExpo');
    this.ease3 = Ease.returnEaseFunc('easeInOutBounce');
  ...
  setupCamera() {
    ...
    this.camera.position.set(0, this.dist * 0.5, this.dist);
  ...
  setupRest() {
    ...
    this.scene.fog = new THREE.Fog(0xFFFFFF, 0, this.dist * 2.0);
...
class Shape {
  constructor(sketch, x, y, z, size, dist, index, shadow, others) {
    ...
    this.position2 = new THREE.Vector3(
      Math.random() * this.sketch.frameSize - this.sketch.frameSize / 2,
      Math.random() * this.sketch.frameSize - this.sketch.frameSize / 2,
      Math.random() * this.sketch.frameSize - this.sketch.frameSize / 2
    );
    this.size = size;
