...
class Shape {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      switch (i) {
        case 0:
          // front
          break;
          this.mesh.position.set(this.position.x, this.position.y, this.position.z - this.size / 2);
          this.group.add(this.mesh);
          this.initPositions.push(new THREE.Vector3(this.position.x, this.position.y, this.position.z - this.size / 2));
        ...
        case 2:
          break;
          // left
          this.mesh.position.set(this.position.x - this.size / 2, this.position.y, this.position.z);
          this.mesh.rotation.y = Math.PI / 2;
          this.group.add(this.mesh);
          this.initPositions.push(new THREE.Vector3(this.position.x - this.size / 2, this.position.y, this.position.z));
        ...
        case 4:
          ...
          this.group.add(this.mesh);
          this.initPositions.push(new THREE.Vector3(this.position.x, this.position.y + this.size / 2, this.position.z));
  ...
  getScaledTime(t, i) {
    ...
    //const scaledTime = t * this.timeScale - i / this.group.children.length - this.index / this.sketch.shapes.length / 1;
  ...
  render() {
    for (let i = 0; i < this.group.children.length; i++) {
      ...
      let st, moveY = 0, posScale = 1, opacity = 1, scale = 1, rotate = 0;
      switch (intT) {
        case 0:
          st = this.sketch.ease(t % 1);

          posScale = Utilities.map(st, 0, 1, 10, 1);
        ...
        case 3:
          ...
          moveY = Utilities.map(st, 0, 1, 0, 1000);
          scale = Utilities.map(st, 0, 1, 1, 0);
      ...
      const newV = 
        this.initPositions[i].clone()
          .add(new THREE.Vector3(0, 0, 0))
          .multiplyScalar(posScale);
