/*
* File Name / misujidate.js
* Created Date / July 27, 2020
...
(function () {
  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    title.textContent = 'MISUJIDATE / 三筋立て';
    ...
    ********************/
    ...
    Shape.prototype.draw = function() {
      ...
      for (var i = 0; i < 3; i++) {
        ctx.beginPath();
        ctx.moveTo(this.x + i * lineDist, this.y);
        ctx.quadraticCurveTo(this.cx + i * lineDist, this.cy, this.x + i * lineDist, Y);
        ctx.stroke();
      }
      ctx.restore();
    };
