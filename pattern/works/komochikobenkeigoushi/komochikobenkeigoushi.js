/*
* File Name / komochikobenkeigoushi.js
...
(function () {
  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    title.textContent = 'KOMOCHIKOBENKEIGOUSHI / 子持小弁慶格子';
    ...
    ********************/
    ...
    Shape.prototype.draw = function() {
      ...
      ctx.beginPath();
      if (this.x === 0) {
        ctx.moveTo(this.x, this.y + style.lineWidth * 1.1);
        ctx.quadraticCurveTo(this.cpx2, this.cpy2 + style.lineWidth * 1.1, X, this.y + style.lineWidth * 1.1);
      }
      if (this.y === 0) {
        ctx.moveTo(this.x + style.lineWidth * 1.1, this.y);
        ctx.quadraticCurveTo(this.cpx1 + style.lineWidth * 1.1, this.cpy1, this.x + style.lineWidth * 1.1, Y);
      }
      ctx.stroke();
      ctx.restore();
    };
