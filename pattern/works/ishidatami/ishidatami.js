...
(function () {
  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    title.textContent = 'ISHIDATAMI / 石畳';
    ...
    ********************/
    ...
    Shape.prototype.draw = function() {
      ...
      if (this.i % 2 === 0) ctx.fillStyle = style.white;
      if (this.j % 2 === 0) ctx.fillStyle = style.black;
      if (this.j % 2 === 0 && this.i % 2 !== 0) ctx.fillStyle = style.white;
      ctx.fillRect(this.xi - this.r / 2, this.yi - this.r / 2, Math.tan(this.rad * 5) + this.r, Math.tan(this.rad * 3) + this.r);
      ctx.restore();
    };
