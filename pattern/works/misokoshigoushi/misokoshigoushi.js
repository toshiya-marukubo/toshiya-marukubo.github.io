...
(function () {
  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    title.textContent = 'MISOKOSHIGOUSHI / 味噌漉格子';
    ...
    ********************/
    ...
    Shape.prototype.draw = function() {
      var ctx  = this.ctx;
      ctx.save();
      if (this.i % 4 === 0) ctx.lineWidth = style.lineWidth * 5;
      if (this.i % 4 !== 0) ctx.lineWidth = style.lineWidth;
