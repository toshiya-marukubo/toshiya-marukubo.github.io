  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    Shape.prototype.draw = function() {
      ...
      if (this.i % 2 === 0) {
        ctx.quadraticCurveTo(this.xi - this.r, this.yi - this.r, this.xi, this.yi - this.r * 2);
        ctx.quadraticCurveTo(this.xi - this.r / 2, this.yi - this.r, this.xi, this.yi);
      } else {
        ctx.quadraticCurveTo(this.xi + this.r, this.yi - this.r, this.xi, this.yi - this.r * 2);
        ctx.quadraticCurveTo(this.xi + this.r / 2, this.yi - this.r, this.xi, this.yi);
      }
