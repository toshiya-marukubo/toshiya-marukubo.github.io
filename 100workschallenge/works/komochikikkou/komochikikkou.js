...
(function () {
  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    title.textContent = 'komochikikkou KOMOCHIKIKKOU / 子持亀甲';
    ...
    ********************/
    ...
    Shape.prototype.draw = function() {
      ...
      ctx.closePath();
      ctx.stroke();
      ctx.lineWidth = Math.sin(this.rad) < 0 ? -Math.sin(this.rad) * 10 + style.lineWidth / 5 : Math.sin(this.rad) * 10 + style.lineWidth / 5;
      ctx.beginPath();
      for (var i = 0; i < 6; i++) {
        var x = Math.sin(i * rad);
        var y = Math.cos(i * rad);
  ...
  // Author
  console.log('File Name / kikkoutsunagi.js\nCreated Date / July 17, 2020\nAuthor / Toshiya Marukubo\nTwitter / https://twitter.com/toshiyamarukubo');
})();
